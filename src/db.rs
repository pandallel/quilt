...
mod tests {
    ...
    async fn test_db_initialization() {
        ...
        assert!(table_sql.contains("material_id"), "Missing material_id column");
        assert!(table_sql.contains("chunk_index"), "Missing chunk_index column");
        assert!(table_sql.contains("content"), "Missing content column");
        assert!(table_sql.contains("created_at"), "Missing created_at column");
        assert!(table_sql.contains("token_count"), "Missing token_count column");
        assert!(table_sql.contains("byte_offset_start"), "Missing byte_offset_start column");
        assert!(table_sql.contains("byte_offset_end"), "Missing byte_offset_end column");
    }
} 